...
public class CircleBarsTexture3D extends IBars3DRenderer {
    ...
    public CircleBarsTexture3D() {
        super( Director.getInstance()
                .loaderShaderFromAssets("shader/instance_vs.glsl"),
                Director.getInstance()
                .loaderShaderFromAssets("shader/tex_color_fs.glsl"));

        mTexture = Director.getInstance().findTexture("images/bar.png");
        initData();
    }
    ...
    private void drawBars() {
        ...
        for (int i = 0; i < mBarCount; i++) {
            ...
            mModelMatrix.translate(cos*radius, sin*radius, 0);
            mModelMatrix.rotate(angelRadius, 0, 0, 1);
            mModelMatrix.scale(mScale.x * th, mScale.y*1.8f, 1);
    ...
    public void render(float delta) {
        ...
        mShader.setUniformVec3("color", mColor.x, mColor.y, mColor.z);
