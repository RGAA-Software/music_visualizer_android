...
public class CircleBarsInstance extends IBarsRenderer {
    ...
    public CircleBarsInstance(String vs, String fs, float radius) {
        super(vs, fs);
        mRadius = radius;
        initRenderer();
        initData();
    ...
    private void initData() {
        ...
        mBottomColor = new Vector3f(0.3f, 0.8f, 0.3f);
        mTopColor = new Vector3f(0.8f, 0.8f, 0.3f);
    ...
    private void drawBars() {
        ...
        for (int i = 0; i < mBarCount; i++) {
            ...
            float extraAngel = (float) Math.atan(mBarWidth/2/radius);
            mModelMatrix = mModelMatrix.rotate(angelRadius + extraAngel, 0, 0, 1);
            mModelMatrix = mModelMatrix.scale(mScale.x * th/3.0f, mScale.y, 1);
